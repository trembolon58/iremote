...
JNIEXPORT jint Java_ru_obsession_iremote_models_Lirc_parse( JNIEnv* env, jobject thiz, jstring filename)
{
...
JNIEXPORT jobjectArray Java_ru_obsession_iremote_models_Lirc_getDeviceList( JNIEnv* env, jobject thiz)
{
...
JNIEXPORT jobjectArray Java_ru_obsession_iremote_models_Lirc_getCommandList( JNIEnv* env, jobject thiz, jstring dev)
{
...
JNIEXPORT jintArray Java_ru_obsession_iremote_models_Lirc_getIrBuffer( JNIEnv* env, jobject thiz,
